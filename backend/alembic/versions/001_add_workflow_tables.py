...
down_revision: Union[str, Sequence[str], None] = "000_create_core_tables"
...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_requisition_stage_history_requisition_id",
        "requisition_stage_history",
        ["requisition_id"],
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "clarification_responded_at", sa.DateTime(timezone=True), nullable=True
        ),
        sa.Column("tender_committee_recommendation", sa.Text(), nullable=True),
        sa.Column(
            "tender_committee_recommended_at", sa.DateTime(timezone=True), nullable=True
        ),
    ...
    op.create_index(
        "ix_internal_approval_details_requisition_id",
        "internal_approval_details",
        ["requisition_id"],
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "technical_query_raised_at", sa.DateTime(timezone=True), nullable=True
        ),
        sa.Column("commercial_query_raised", sa.Boolean(), default=False),
        sa.Column("commercial_query_sheet", sa.Text(), nullable=True),
        sa.Column(
            "commercial_query_raised_at", sa.DateTime(timezone=True), nullable=True
        ),
        sa.Column("clarification_response_received", sa.Boolean(), default=False),
        sa.Column(
            "clarification_response_at", sa.DateTime(timezone=True), nullable=True
        ),
    ...
    op.create_index(
        "ix_tender_evaluation_tender_id", "tender_evaluation", ["tender_id"]
    )
    ...
    op.create_index(
        "ix_bid_evaluation_details_bid_id", "bid_evaluation_details", ["bid_id"]
    )
    op.create_index(
        "ix_bid_evaluation_details_tender_evaluation_id",
        "bid_evaluation_details",
        ["tender_evaluation_id"],
    )
    ...
    op.create_index(
        "ix_comparative_statements_tender_id", "comparative_statements", ["tender_id"]
    )
    ...
    op.create_index(
        "ix_tender_negotiations_tender_id", "tender_negotiations", ["tender_id"]
    )
    ...
    op.create_index(
        "ix_tender_committee_recommendations_tender_id",
        "tender_committee_recommendations",
        ["tender_id"],
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "security_deposit_submitted_at", sa.DateTime(timezone=True), nullable=True
        ),
    ...
    op.create_index(
        "ix_order_execution_details_order_id", "order_execution_details", ["order_id"]
    )
    ...
    op.create_index(
        "ix_tender_cancellations_tender_id", "tender_cancellations", ["tender_id"]
    )
    op.create_index(
        "ix_tender_cancellations_requisition_id",
        "tender_cancellations",
        ["requisition_id"],
    )
